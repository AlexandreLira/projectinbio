        ...
        <div className="my-[150px] flex flex-col items-center gap-14">
            ...
            <div className="flex flex-col items-center gap-6">
                <h3 className="text-4xl font-bold text-white">
                    Um valor acessível para todo
                </h3>
                <p className="text-center-body text-xl text-center">
            ...
            <div className="flex items-end gap-9">
                ...
                <div className="flex flex-col">
                    <div className="flex justify-center items-center rounded-t-2xl p-2 w-[304px] bg-gradient-to-r from-[#4B2DBB] to-[#B5446B]">
                        <span className="uppercase text-xs font-bold">Recomendado</span>
                    </div>

                    <div className="p-[1.6px] rounded-b-2xl bg-gradient-to-r from-[#4B2DBB] to-[#B5446B]">
